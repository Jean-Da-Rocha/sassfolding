    ...
    <UDashboardGroup>
      ...
      >
        <template #header="{ collapsed }">
          <svg
            v-if="!collapsed"
            class="h-5 w-auto shrink-0" fill="none" height="200" viewBox="0 0 1020 200" width="1020" xmlns="http://www.w3.org/2000/svg"
          >
            ...
            <path clip-rule="evenodd" d="M1000 60.0233L1020 60V77L1020 128V156.007L1020 181L1020 189.004C1020 192.938 1019.98 194.429 1017 197.001C1014.02 199.725 1009.56 200 1005 200H986.001V181.006L986 130.012V70.0215C986 66.1576 986.016 64.5494 989 62.023C991.819 59.6358 995.437 60.0233 1000 60.0233Z" fill="var(--ui-primary)" fill-rule="evenodd" />
          </svg>
          <UIcon v-else class="mx-auto size-5 text-primary" name="i-simple-icons-nuxtdotjs" />
        </template>
